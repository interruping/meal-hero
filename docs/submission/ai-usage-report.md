...
[사람: 디렉터]
   ...
   ▼
[Claude Code (모델: Claude Fable 5)] ──── 게임 코드 전체 작성 (Three.js + Vite, 약 5,700줄)
   │        │
...
| 도구 | 용도 | 사용량·비용 |
|---|---|---|
| **Claude Code** (Anthropic — 모델: **Claude Fable 5**) | 게임 코드 전체, 에셋 파이프라인 스크립트 작성·실행, 브라우저 검증 자동화, 문서 | 개발 전 과정 |
...
### 2.1 Claude Code — 코드·파이프라인·검증 (사용 모델: Claude Fable 5)
