...
const CLIPS = [
  ...
  // §19.1·§19.3 (FR-58/59/61) 8차 피드백 보이스 4종
  {
    file: 'voice-safe.mp3',
    voice: 'ballad',
    system: '당신은 한국 동네 식당의 정 많은 사장님입니다. 배달 기사에게 음식을 건네며 지시된 대사만 밝고 상냥하게, 빠르고 경쾌한 속도로 딱 한 번 말하세요. 늘여 읽기 금지, 다른 말 금지.',
    text: '안전히 배달해주세요~',
  },
  {
    file: 'voice-wrong.mp3',
    voice: 'ballad',
    system: '당신은 한국 동네 식당의 사장님입니다. 배달 기사가 다른 주문을 잘못 집어간 것을 보고 지시된 대사만 다급하고 당황한 목소리로 빠르게 딱 한 번 외치세요. 늘여 읽기 금지, 다른 말 금지.',
    text: '기사님 잘못 가져가셨어요~!',
  },
  {
    file: 'voice-enjoy.mp3',
    voice: 'echo',
    system: '당신은 씩씩한 한국 배달 기사입니다. 손님에게 음식을 건네며 지시된 대사만 기분 좋고 예의 바르게, 빠르고 경쾌한 속도로 딱 한 번 말하세요. 늘여 읽기 금지, 다른 말 금지.',
    text: '맛있게 드세요',
  },
  {
    file: 'voice-fast.mp3',
    voice: 'sage',
    system: '당신은 배달을 시킨 한국인 손님입니다. 음식이 생각보다 빨리 도착해 놀라고 기뻐하며 지시된 대사만 감탄하듯 빠르고 경쾌하게 딱 한 번 말하세요. 늘여 읽기 금지, 다른 말 금지.',
    text: '와우 빨리 오셔서 감사해요!',
  },
];
